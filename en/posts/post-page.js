document.addEventListener('DOMContentLoaded', async function() {
    ...
    async function fetchPosts() {
        ...
        const jsonPath = isArabic ? '../../blog-posts.json' : '../../blog-posts.json';
        try {
    ...
    function renderAuthorBox(author) {
        ...
        // Check if the author object and avatar property exist before rendering
        ...
        authorContainer.innerHTML = `
            <div class="author-box">
                <div class="author-avatar">
                    <!-- Use the avatar path directly from the JSON file -->
    ...
    function handleScroll() {
        ...
        headings.forEach(heading => {
            ...
            if (rect.top < 150) { // 150px from top of viewport
    ...
    async function main() {
        ...
        const postId = pathSegments.pop(); // last part of URL (the post id)
        ...
        if (post) {
            renderPost(post);
            // These functions must run AFTER post content is in the DOM
            generateTOC(); 
